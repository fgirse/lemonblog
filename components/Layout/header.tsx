      ...
      <div className="px-4 py-0 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="relative text-[#FFF44F] flex items-center justify-between">
          <Link href={"/"} className="inline-flex items-center">
            ...
            <span className="ml-2 text-xl font-bold tracking-wide text-gray-100 hover:text-white transition-all duration-300 uppercase"></span>
          </Link>
          <ul className=" justify-start items-center hidden lg:flex lg:gap-x-1 lg:justify-center">
            <li>
              <div className="hover:scale-110 transition-transform duration-300 hover:bg-amber-500/50 rounded-lg flex justify-center items-center gap-x-1">
                <Image
                  src={"Assets/Svg/Bulleye.svg"}
                  alt="Bulleye"
                  width={10}
                  height={10}
                  sizes="100vw"
                  className="w-0 h-0 lg:w-12 lg:h-12"
                />
          ...
          <ul className="flex items-center hidden space-x-6 lg:flex">
            ...
            <Link href="/new">
              <button
                type="button"
                className="px-8 py-3 font-semibold inline-flex items-center gap-2 rounded-full bg-gray-100 text-black"
              >
                <span>Create</span>
                <svg
            ...
            <div className="fixed lg:hidden bottom-0 left-0 z-50 rounded-tl-2xl rounded-tr-2xl w-full border-t b bg-gray-900 border-gray-800">
              <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium ">
                <Link href="/">
                  <button
                    type="button"
                    className="inline-flex flex-col items-center justify-center px-5 py-2 hover:bg-gray-800 group"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
