...
const About = () => (
  ...
  >
    ...
    >
      ...
      >
        <h1 className="text-[2.5rem] lg:text-[4rem] font-extrabold text-yellow-500 text-center">
          &quot;Moin Moin&quot;
        </h1>
        ...
        <p className="mt-5 text-[1.33rem] text-gray-300 md:text-[1.33rem] lg:text-[1.66rem]">
          ...
          wohl kein zweites Mal gibt. Ausgebaut im Stile eines Schiffrumpfes,
          ist der im Zentrum der Altstadt gelegene Rettungsanker-Freiburg
          idealer Treffpunkt um nach Feierabend etwas zu entspannen und nette
          Leute kennenzulernen. Wir sind stolz auf unser buntes, internationales
      ...
      <div className="flex flex-col items-center justify-center">
        <Tooltip
          fontSize="0.866rem"
          padding="2px"
          content="sende email an rettungsanker-freiburg@gmx.de"
          direction="top"
          border="#ffffff"
          background="#898989"
        >
