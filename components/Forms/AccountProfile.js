...
function AccountProfile({ user }) {
  ...
  return (
    <form
      ...
      className="flex flex-col justify-start gap-2.5 space-y-1"
    >
      ...
      <center>
        <button
          type="submit"
          className=" w-fit cursor-pointer my-2 py-3 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-black focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 inline-flex items-center"
        >
          {loading ? (
            <>
              <svg
