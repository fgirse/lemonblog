...
function UploadPost({ userId }) {
  ...
  return (
    <form
      ...
      className="mx-auto grid px-4 max-w-screen-md gap-4 sm:grid-cols-2"
    >
      <div className="sm:col-span-2 pb-4">
        <label className="mb-2 inline-block text-sm text-gray-300 sm:text-base">
          Post Title*
        </label>
        <input
          required
      ...
      <div className="sm:col-span-2">
        ...
        <textarea
          ...
          className="h-64 w-full rounded border bg-[#191919] px-3 py-2 text-gray-100 outline-none border-[#121212] ring-gray-600 transition duration-100 focus:ring"
        ></textarea>
      </div>
