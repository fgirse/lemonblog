    ...
    <div>
      <Link href={`/blogs/${id}`}>
        <div className="group relative cursor-pointer mb-2 block h-68 overflow-hidden rounded-lg bg-gray-100 lg:mb-3">
          ...
          <span className="absolute right-0 top-0 rounded-bl-lg bg-[#FFF44F] px-3 py-1.5 text-sm tracking-wider text-black">
            {readingTime}m Read
          </span>
          <div className="absolute bottom-2 left-4 ">
            ...
            >
              ...
              <span className="hover:underline font-medium text-black mx-1.5">
                {author?.username}
              </span>
            </Link>
          </div>
